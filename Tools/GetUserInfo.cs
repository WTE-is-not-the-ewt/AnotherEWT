...
namespace AnotherEWT.Tools
{
    ...
    {
        public static async Task<FullUserData> GetInfo(string token)
        {
            ...
            return JsonConvert.DeserializeObject<FullUserData>(response.Content);
        }
    }

    public class TokenGetter
    {
        public static string GetToken(string c)
        {
